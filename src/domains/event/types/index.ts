...
export type RecruitmentStatus = 'draft' | 'pending' | 'open' | 'closed' | 'in_progress' | 'completed' | 'hidden'

export type ApplicationStatus = 'submitted' | 'reviewing' | 'accepted' | 'rejected' | 'canceled'
