  ...
  if (submitted) {
    return (
      <div className="bg-secondary-container rounded-2xl p-6 text-center mb-6">
        <p className="font-display font-bold text-title-sm text-on-secondary-container mb-1">
          신청 완료!
        </p>
    ...
    <div className="mb-6">
      ...
      {open && (
        <form
          ...
          className="mt-4 bg-surface-container rounded-2xl p-6 space-y-4"
        >
          <FormInput
            label="닉네임"
            required
            registration={form.register("nickname")}
          ...
          <FormInput
            ...
            registration={form.register("portfolio")}
          />
          <button
            type="submit"
